	...
	constructor(
		...
		private inner class DataChip(
			...
			fun bind(model: ChipModel) {
				...
				isCloseIconVisible =
					if (model.isCloseable || model.isDropdown) {
